...
Sistema de gestión de tareas implementado con arquitectura orientada a objetos, integración con API externa DummyJSON, persistencia en LocalStorage, y interfaz Bootstrap.

### Arquitectura Implementada

El proyecto sigue una **arquitectura Java-like** con separación clara de responsabilidades para acostumbrarse al modelo:
