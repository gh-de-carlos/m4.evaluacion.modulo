...
class ListaTareas {
    ...
    crearElementoTarea(tarea) {
        ...
        const colorBorde = tarea.completada ? 'border-success' : 'border-warning';
            ...
            <div class="card-body ${colorBorde}">
                <div class="d-flex justify-content-between align-items-start">
                    <div class="flex-grow-1 ${estadoClass}">
                        ...
                        ${tarea.descripcion ? `<p class="card-text task-description mb-2">${this.escapeHtml(tarea.descripcion)}</p>` : ''}
